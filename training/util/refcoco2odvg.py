...
def process_item(args, filename):
    ...
    for img_id in tqdm(ids):
        ...
        for anno in annos:
            ...
            tokens_positive = anno.get('tokens_positive', [])
            x1, y1, w, h = box
...
def main():
    args = parse_args()
    process_item(args, 'expression_all_train_set_coco_format.json')
    process_item(args, 'expression_pos_final_val_set_coco_format.json')
